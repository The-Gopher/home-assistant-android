...
class ClimateWidgetConfigureActivity : BaseActivity() {
    companion object {
        ...
        fun newInstance(context: Context, entityId: String): Intent =
            Intent(context, ClimateWidgetConfigureActivity::class.java).apply {
...
@Composable
private fun ClimateWidgetConfigureScreen(
    viewModel: ClimateWidgetConfigureViewModel,
    onActionClick: () -> Unit,
) {
        ...
        Column(
            ...
            HATheme {
                EntityPicker(
                    ...
                    deviceRegistry = deviceRegistry,
                    areaRegistry = areaRegistry,
                    addButtonText = stringResource(commonR.string.widget_climate_select_entity),
                )
            }
